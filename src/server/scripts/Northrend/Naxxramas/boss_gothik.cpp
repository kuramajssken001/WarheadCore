...
{
    { NPC_LIVING_TRAINEE,    20s },
    { NPC_LIVING_TRAINEE,    20s },
    { NPC_LIVING_TRAINEE,    10s },
    { NPC_LIVING_KNIGHT,     10s },
    { NPC_LIVING_TRAINEE,    15s },
    { NPC_LIVING_KNIGHT,     10s },
    { NPC_LIVING_TRAINEE,    15s },
    { NPC_LIVING_TRAINEE,    0s },
    { NPC_LIVING_KNIGHT,     10s },
    { NPC_LIVING_RIDER,      10s },
    { NPC_LIVING_TRAINEE,    5s },
    { NPC_LIVING_KNIGHT,     15s },
    { NPC_LIVING_RIDER,      0s },
    { NPC_LIVING_TRAINEE,    10s },
    { NPC_LIVING_KNIGHT,     10s },
    { NPC_LIVING_TRAINEE,    10s },
    { NPC_LIVING_RIDER,      5s },
    { NPC_LIVING_KNIGHT,     5s },
    { NPC_LIVING_TRAINEE,    20s },
    { NPC_LIVING_RIDER,      0s },
    { NPC_LIVING_KNIGHT,     0s },
    { NPC_LIVING_TRAINEE,    15s },
    { NPC_LIVING_TRAINEE,    29s },
    { 0, 0s }
};
